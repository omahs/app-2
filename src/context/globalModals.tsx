...
type GlobalModalsContextType = {
  ...
  isCommitteeMembersOpen: boolean;
...
const GlobalModalsProvider: React.FC<Props> = ({children}) => {
  ...
  const [isCommitteeMembersOpen, setIsCommitteeMembersOpen] =
    useState<GlobalModalsContextType['isCommitteeMembersOpen']>(false);
  ...
  const open = (type?: MenuTypes) => {
    switch (type) {
      ...
      case 'committeeMembers':
        setIsCommitteeMembersOpen(true);
        break;
      default:
  ...
  const close = (type?: MenuTypes) => {
    switch (type) {
      ...
      case 'poapClaim':
        ...
        break;
      case 'committeeMembers':
        setIsCommitteeMembersOpen(false);
        break;
      default:
